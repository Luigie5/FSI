...
example_batch_train, label_batch_train = dataSource(["data3/0/train/*.jpg", "data3/6/train/*.jpg", "data3/2/train/*.jpg"], batch_size=batch_size)
example_batch_valid, label_batch_valid = dataSource(["data3/0/validar/*.jpg", "data3/6/validar/*.jpg", "data3/2/validar/*.jpg"], batch_size=batch_size)
example_batch_test, label_batch_test = dataSource(["data3/0/test/*.jpg", "data3/6/test/*.jpg", "data3/2/test/*.jpg"], batch_size=batch_size)
