...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            problem.setExpandidos(expandidos)
            return node
...
def busqueda_ramificacion(problem):
    return graph_search(problem, Ramificacion())

def busqueda_ramificacionSubestimada(problem):
    return graph_search(problem, RamificacionSubestimada(problem))
